...
namespace gallt {
    ...
    inline bool builtin_type_by_name(const std::string& name, AST::Type& out) {
        if (name == "int") {
            out = AST::Type::make_int();
        } else if (name == "lint") {
            out = AST::Type::make_lint();
        } else if (name == "uint") {
            out = AST::Type::make_uint();
        } else if (name == "luint") {
            out = AST::Type::make_luint();
        } else if (name == "float") {
            out = AST::Type::make_float();
        } else if (name == "double") {
            out = AST::Type::make_double();
        } else if (name == "char") {
            out = AST::Type::make_char();
        } else if (name == "uchar") {
            out = AST::Type::make_uchar();
        } else if (name == "bool") {
            out = AST::Type::make_bool();
        } else if (name == "string") {
            out = AST::Type::make_string();
        } else if (name == "file") {
            out = AST::Type::make_file();
        } else if (name == "void") {
            out = AST::Type::make_void();
        } else {
            return false;
        }
        return true;
