...
namespace gallt {
    ...
    void CodeGenerator::emit_output_call(AST::PostfixExpression* call) {
        for (std::size_t arg_index = 0; arg_index < call->arguments.size();
            ...
            if (emit_output_pack_expansion(arg_expr.get())) {
                continue;
            }
            ...
            if (prim->kind == AST::PrimaryExpression::Kind::Identifier) {
                ...
                if (local != nullptr) {
                    ...
                    if (id == "int") {
                        ...
                        target = Type::make_lint();
                    } else if (id == "uint") {
                        target = Type::make_uint();
                    } else if (id == "luint") {
                        target = Type::make_luint();
                    } else if (id == "float") {
                        target = Type::make_float();
                    } else if (id == "double") {
                        target = Type::make_double();
                    } else if (id == "char") {
                        target = Type::make_char();
                    } else if (id == "uchar") {
                        target = Type::make_uchar();
                    } else if (id == "bool") {
                        target = Type::make_bool();
                    } else if (id == "string") {
                        target = Type::make_string();
                    } else if (id == "file") {
                        target = Type::make_file();
                    } else if (id == "void") {
