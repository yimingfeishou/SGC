...
namespace gallt {
    ...
    namespace {
        ...
        const ErrorTemplateEntry kErrorTemplates[] = {
            ...
            { ErrorCode::CompileTimeConditionOutsideGenericBlock, "a compile-time condition may not be used outside a generic block, nor inside the code generated by a generic body (including but not limited to emit)" },
        };
    }
