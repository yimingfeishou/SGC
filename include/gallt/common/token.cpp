// common/token.cpp
// Token 辅助函数实现
// Implementation of token helper functions
...
namespace gallt {
    ...
    namespace {
        // 关键字文本到 TokenType 的映射（与词法分析器中的表格一致）
        // Keyword text-to-TokenType map, kept consistent with the lexer table
